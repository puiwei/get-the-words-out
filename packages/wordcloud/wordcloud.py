...
class colormap_color_func(object):
    ...
    def __call__(self, color):
        if (color < 0):
            #redMap = [[50, 50, 50], [72, 64, 64], [95, 74, 74], [118, 78, 78], [141, 78, 78], [163, 72, 72], [186, 62, 62], [209, 46, 46], [232, 25, 25], [255, 0, 0]]
            #redMap = [[255, 255, 255],[255, 226, 226],[255, 198, 198],[255, 170, 170],[255, 141, 141],[255, 113, 113],[255, 85, 85],[255, 56, 56],[255, 28, 28],[255, 0, 0]]
            redMap = [[128,0,128], [142,0,114], [156,0,100], [170,0,85], [184,0,71], [199,0,57], [213,0,43], [227,0,28], [241,0,14], [255,0,0]]
            index = abs(round(color * 9))
            r, g, b = redMap[index]
        elif (color > 0):
            #blueMap = [[50, 50, 50], [44, 44, 72], [38, 38, 95], [33, 33, 118], [27, 27, 141], [22, 22, 163], [16, 16, 186], [11, 11, 209], [5, 5, 232], [0, 0, 255]]
            blueMap = [[128,0,128],[114,0,142],[100,0,156],[85,0,170],[71,0,184],[57,0,199],[43,0,213],[28,0,227],[14,0,241],[0,0,255]]
            index = abs(round(color * 9))
            r, g, b = blueMap[index]
        else:
            r = 128
...
class WordCloud(object):
    ...
    def generate_from_frequencies(self, frequencies, max_font_size=None):
        ...
        for wordCombo, freq in frequencies:
            word, polar = wordCombo.split(":")
            orig_frequencies.append([word, freq])
        ...
        for wordCombo, freq in frequencies:
            ...
            colors.append(self.color_func(float(polar)))
        ...
        self.layout_ = list(zip(orig_frequencies, font_sizes, positions,
                                orientations, colors))
        return self
    ...
    def process_text(self, text):
        ...
        for eachWord in words:
            word, strcount, strpolar = eachWord.split(":")
            count = int(float(strcount) * 10000)
            #polar = int(float(strpolar) * 10000)
            word_counts[word + ":" + strpolar] = count
